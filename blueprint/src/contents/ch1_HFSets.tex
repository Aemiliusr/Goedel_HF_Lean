...
\begin{lemma}
    ...
    \lean{HF.notin_empty, HF.mem_enlarge, HF.mem_enlarge_empty}
    \leanok
...
\begin{definition}
    ...
    \lean{HF.insert, HF.singleton, HF.pair}
    \leanok
...
\begin{lemma}
    ...
    \lean{HF.mem_singleton, HF.mem_pair, HF.duplic_pair_eq_single, HF.pair_inj}
    \leanok
...
\begin{definition}
    ...
    \lean{HF.IsTrans, HF.IsOrd, HF.Ord}
    \leanok
...
\begin{lemma}
    ...
    \lean{HF.IsOrd.succ_isOrd, HF.IsOrd.mem_isOrd, HF.empty_isOrd, 
    HF.IsOrd.empty_of_mem_and_disjoint, HF.IsOrd.empty_is_mem, HF.Ord.empty_is_lt}
    \leanok
...
\begin{theorem}[Comparability of ordinals]
    ...
    \lean{HF.IsOrd.comparability, HF.Ord.comparability}
    \leanok
...
\begin{corollary}
    ...
    \lean{HF.IsOrd.exclusive_comparability, HF.Ord.exclusive_comparability, 
    HF.IsOrd.sSubset_iff_mem, HF.Ord.sSubset_iff_lt, HF.IsOrd.succ_eq_or_succ_mem, 
    HF.Ord.succ_eq_or_succ_lt, HF.IsOrd.succ_inj, HF.Ord.succ_inj}
    \leanok
...
\begin{theorem}
    ...
    \lean{HF.Ord.le_totalOrder, HF.Ord.lt_sTotalOrder}
...
\begin{theorem}
    ...
    \lean{HF.IsOrd.exists_max_of_set, HF.IsOrd.exists_min_of_set}
    \leanok
...
\begin{definition}[Predecessor]
    ...
    \lean{HF.IsOrd.pred, HF.Ord.pred}
    \leanok
...
\begin{definition}[Functional]
    ...
    \lean{HF.IsFunctionalUnary, HF.IsFunctionalBinary, HF.IsFunctionalTernary}
    \leanok
...
\begin{definition}[\textit{p}-function]
    \label{def:pFunc}
    \lean{HF.pFuncUnary, HF.pFuncBinary, HF.pFuncTernary}
    \leanok
