\section{The Theory of Hereditarily Finite Sets}
...
\begin{notation*}
    ...
    \lean{HF.single, HF.pair, HF.ord_pair}
    \leanok
    \leavevmode \normalfont
    \begin{enumerate}
...
\begin{lemma}
    \label{lem:two}
    \lean{HF.single_iff, HF.pair_iff, HF.double_pair, HF.ord_pair_equal}
    \leanok
    \uses{lem:one, thm:exten_prop}
    \leavevmode \normalfont
    \begin{enumerate}
