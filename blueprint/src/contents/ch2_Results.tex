...
We start by showing that most of the ZF axioms are theorems of HF.
...
\begin{theorem}
    ...
    \uses{ax:induction_axiom, lem:Ord.R.sSubset_of_lt+Ord.R.isTrans, def:rank, 
        thm:rank.lt_of_mem, def:cl}
