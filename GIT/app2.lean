...
-- formalised. It presents the theory on hereditarily finite ordinals.
...
-- By 'set' we mean an 'HF set'; by 'collection' we mean a 'Lean set' (i.e. a set not necessarily HF).
